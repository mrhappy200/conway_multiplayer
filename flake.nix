{
  ...
  outputs = inputs @ {
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in {
        packages = {
          conway_multiplayer-bin = craneLib.buildPackage {
          ...
          conway_multiplayer-assets = pkgs.stdenv.mkDerivation {
          ...
          conway_multiplayer = pkgs.stdenv.mkDerivation {
          ...
          conway_multiplayer-web = pkgs.stdenv.mkDerivation {
